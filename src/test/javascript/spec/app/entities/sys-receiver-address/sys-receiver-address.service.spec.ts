...
import { ISysReceiverAddress, SysReceiverAddress } from 'app/shared/model/sys-receiver-address.model';

describe('Service Tests', () => {
    describe('SysReceiverAddress Service', () => {
        let injector: TestBed;
        let service: SysReceiverAddressService;
        let httpMock: HttpTestingController;
        let elemDefault: ISysReceiverAddress;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SysReceiverAddressService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SysReceiverAddress', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        createTime: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new SysReceiverAddress(null))
                    .pipe(take(1))
            ...
            it('should delete a SysReceiverAddress', async () => {
